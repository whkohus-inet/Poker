...
tables[0] = new Table( 0, 'CNY Table 10', eventEmitter(0), 10, 10, 5, 1000, 1, false );
/*
tables[0] = new Table( 0, 'Sample 10-handed Table', eventEmitter(0), 10, 2, 1, 200, 40, false );
*/
tables[1] = new Table( 1, 'CNY Table 6', eventEmitter(1), 6, 10, 5, 1000, 1, false );
tables[2] = new Table( 2, 'CNY Table 2', eventEmitter(2), 2, 10, 5, 1000, 1, false );
/*
